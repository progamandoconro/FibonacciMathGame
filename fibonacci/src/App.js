...
function App() {
  ...
  const [nValue, nValueHandler] = useState(1);
  const [userAnswer, userAnswerHandler] = useState(1);
 ...
 const fiboHandler = (n)=>{
  ...
  if (correctAnswer.toString() === userAnswer) alert('Woowow'+ correctAnswer +"genius")
